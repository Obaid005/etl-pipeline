...
export class AppService {
  ...
  async createTestOrder(orderData: OrderInput): Promise<any> {
  ...
  async createTestDevice(deviceData: DeviceInput): Promise<any> {
  ...
  async createTestUserActivity(activityData: ActivityInput): Promise<any> {
